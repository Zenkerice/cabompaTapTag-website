...
$username = $email = $password = $tagID = $pin = "";
$error = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(!preg_match('/^[0-9]{4}$/', $pin)){
        ...
        if(mysqli_num_rows($check) > 0){
            ...
            $insert = mysqli_query($conn, "INSERT INTO users (username, email, password, edit_pin)
                VALUES ('$username', '$email', '$hashed_password', '$hashed_pin')");

            if($insert){
                $user_id = mysqli_insert_id($conn);
                if(!empty($tagID)){
                    mysqli_query($conn, "UPDATE tags SET user_id='$user_id' WHERE tag_id='$tagID'");
                }
...
<head>
    ...
    <title>Create Your Space - TapTag</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pin-label-row label { margin-bottom: 0; }
...
<body>
    ...
    <div class="center-wrap">
        <div class="signup-card">
            ...
            <h1>Create Your <span>Space.</span></h1>
            <p class="subtitle">Set up your profile in seconds — it's free.</p>
            ...
            <form method="POST" action="">
                ...
                <div class="field">
                    ...
                    <div class="input-wrap">
                        ...
                        <button type="button" class="eye-toggle" onclick="togglePassword()" aria-label="Toggle password">
                ...
                <div class="field pin-section">
                    <div class="pin-label-row">
                        <label for="pin">4-Digit Edit PIN</label>
                        <span class="pin-hint">Used to unlock profile editing</span>
                    </div>
                ...
                <input type="hidden" name="tag_id" value="<?php echo isset($_GET['tag']) ? htmlspecialchars($_GET['tag']) : ''; ?>">
